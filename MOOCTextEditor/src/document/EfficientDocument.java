...
public class EfficientDocument extends Document {
	...
	private void processText() {
		...
		// if last entry is a word, that counts as a sentence still
		if (tokens.size() != 0) {
	...
	public static void main(String[] args) {
		...
		testCase(new EfficientDocument(
				"Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."), 32,
				15, 1);
